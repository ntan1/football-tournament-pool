function addFixture(match) {
    ...
    let homePredict = $(`<input type="text" size="2" class="home-result">`);
    homePredict.val(predictions[match.id]["home_result"]);
    let awayPredict = $(`<input class="away-result" type="text" size="2">`);
    awayPredict.val(predictions[match.id]["away_result"]);
